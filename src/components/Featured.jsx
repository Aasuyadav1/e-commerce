...
function Featured() {
  ...
  const clickedfeatured = (productId) => {
    const selectedProduct = featuredData.find(
  ...
  const buttonHandle = (productId) => {
    ...
    if (clickedProduct) {
      ...
      if (isInCart) {
        setCartItems((prev) =>
          prev.filter((item) => item.id !== clickedProduct.id)
        );
      } else {
            ...
            <div className="flex justify-center gap-[20px] max-w-[1000px] w-full max-[831px]:flex-wrap">
              ...
              <div className="flex flex-col justify-between ">
                <div>
                  ...
                  <p className="mt-[0px] font-bold text-[1.1rem] max-[831px]:mt-[10px]">
                    $ {selectedProduct.price}
                  </p>
                  <p className="mt-[10px] text-[0.8rem]">
