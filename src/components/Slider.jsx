...
function Slider() {
  const images = [
    {
      url: "https://i.postimg.cc/zDdhfw8d/Blue-Ecommerce-Online-Shopping-Linked-In-Banner.png",
      id: 1,
    },
    {
        ...
        {images.map((cur) => (
          <div className="each-slide-effect" key={cur.id}>
            <img
              src={cur.url}
              alt=""
              className=" max-[600px]:min-h-[200px] max-[600px]:h-full h-[200px] w-full object-cover"
            />
